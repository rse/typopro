...
- cURL: download directly from the Github repository:<br/>
  ...
  `$ curl -O https://github.com/rse/typopro-web/archive/3.7.5.zip`

- cURL: download directly from the Github repository:<br/>
  `$ curl -O https://github.com/rse/typopro-dtp/archive/master.zip`<br/>
  `$ curl -O https://github.com/rse/typopro-dtp/archive/3.7.5.zip`
